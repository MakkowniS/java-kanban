...
public class GsonListTypes {
    public static final Type TASKS_LIST = new TypeToken<List<Task>>() {
    }.getType();
    public static final Type SUBTASKS_LIST = new TypeToken<List<Subtask>>() {
    }.getType();
    public static final Type EPICS_LIST = new TypeToken<List<Epic>>() {
    }.getType();
}
